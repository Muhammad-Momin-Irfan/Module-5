...
(function (global) {
  ...
  function buildAndShowHomeHTML(categories) {
    $ajaxUtils.sendGetRequest(homeHtmlUrl, function (homeHtml) {
      ...
      var chosenCategoryShortName = "'" + chosenCategory.short_name + "'"; // Step 2 & 3
      var homeHtmlToInsert = insertProperty(homeHtml, "randomCategoryShortName", chosenCategoryShortName); // Step 3
      insertHtml("#main-content", homeHtmlToInsert); // Step 4
    }, false);
  }
